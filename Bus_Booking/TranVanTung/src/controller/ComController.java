	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case 1: //Update ticket
			...
			try {
				...
				out.print(model.status.getStatus(status));
			...
			break;
		case 2: // UPdate role User
			id = Integer.parseInt(request.getParameter("id"));
			int role = Integer.parseInt(request.getParameter("role"));
			user.updateRole(id, role);
			out.print(model.UsersRole.getStatus(role));
			break;
		case 3: // Update User information
			...
			user.updateUsers();
			out.print(model.UsersRole.getStatus(roleUser));
			break;
		...
		case 4: //create new user from admin
			...
			user.Resign();
			break;
		case 5: //Booking ticket
			id = Integer.parseInt(request.getParameter("id"));
			user = (Users)session.getAttribute("USER");
		
			int IdUser = user.getId();

			ticket.bookingticket(id,IdUser);
			break;
		default:
			break;
		}
