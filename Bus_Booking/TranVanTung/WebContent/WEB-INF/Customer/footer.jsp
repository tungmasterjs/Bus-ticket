<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <script src="${pageContext.request.contextPath}/resouce/cus/js/owl.carousel.min.js"></script>
    <script src="${pageContext.request.contextPath}/resouce/cus/js/main.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/resouce/ajax/cusAjax.js"></script>
    <script>
    	$('#formResign').validate({
    		rules:{
    			name: "required",
